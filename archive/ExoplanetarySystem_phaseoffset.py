...
class ExoplanetarySystem_phaseoffset:
    ...
    def compute_longitude_latitude(self):
        ...
        numberoflongitude = 90 # 180
        numberoflatitude = 60 # 90
    ...
    def compute_temperature_and_intensity(self, reflection_mode="grid"):
        """
        ...
        if reflection_mode=="grid":
            ...
            self.reflectedplanetartintensity = np.tile(self.albedo * np.maximum(0, np.cos(self.longitudearray + np.radians(self.cloud_offset))) * ISS_band, (len(self.latitudearray), 1))
